...
class ShopTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'img_src' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/sushi.jpg'
        ];
        ...
        $param = [
            ...
            'img_src' =>'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/yakiniku.jpg'
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '戦慄',
            ...
            'img_src' =>'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg'
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => 'ルーク',
            ...
            'img_src' =>'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/italian.jpg'
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '志摩屋',
            ...
            'img_src' =>'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/ramen.jpg'
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '香',
